# x86 TSO, Sequential Consistency & Linearizability

*A conversation with ChatGPT: what it takes to get sequential consistency on x86-TSO, how linearizability differs from SC, and why SC alone doesn't imply linearizability even for single-location reads and writes.*
...
<table style="margin: 32px 0 20px auto; max-width: 75%; border-collapse: separate; border: none;">
<tr><td style="background: #1e3f73; color: #ffffff; border: none; border-radius: 20px; padding: 12px 18px; line-height: 1.5;">
<strong style="font-size: 1.4em;">Q:</strong>&nbsp; So, that means, that for operations on individual memory addresses (not compound operations) SC and linearizability on x86 are essentially the same and having SC automatically means having linearizable consistency?
</td></tr>
</table>
